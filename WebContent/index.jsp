...
<html lang="en" data-ng-app="MetronicApp">
    ...
    <head>
        <title translate>Hệ thống quản lý KTNB
        </title>
        <meta charset="utf-8" />
      ...
      <!--   <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" /> -->
       <link href="${pageContext.request.contextPath}/erp/assets/css/coms-style.css " rel="stylesheet" type="text/css" />
...
<link href="${pageContext.request.contextPath}/assets/global/kendoui/styles/kendo.bootstrap.min.css" rel="stylesheet" type="text/css" />
	...
	<![endif]-->
        ...
        <!-- HOANGNH START LIBRARY ANGULAR DATE PICKER --ADD -->
        
        <!-- HOANGNH START LIBRARY ANGULAR DATE PICKER -- END -->
        ...
        <script src="${pageContext.request.contextPath}/js/mainvps.js?t=20230628" type="text/javascript"></script>
...
<%--        <script src="${pageContext.request.contextPath}/qlhc/component/ComboBoxSecondAsset.js" type="text/javascript"></script>--%>
	    ...
	    <script src="${pageContext.request.contextPath}/erp/assets/js/isNumber.js"></script>
	    <script src="${pageContext.request.contextPath}/erp/assets/js/initCommonFunction.js"></script>

        <!-- TODO remove map -->
<%--        <!-- google map -->--%>
<%--        <script src="https://maps.google.com/maps/api/js?key=AIzaSyD9qNS33El61m0ICD0Sjh-6iUkXUloeizw&libraries=drawing,geometry"></script>--%>
...
<!-- HuyPQ-start -->
<link href="${pageContext.request.contextPath}/assets/global/plugins/chart/export.css" rel="stylesheet" type="text/css" />
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/amcharts.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/export.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/fabric.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/FileSaver.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/gauge.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/light.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/loader.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/pdfmake.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/pie.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/serial.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/global/plugins/chart/vfs_fonts.js" type="text/javascript"></script>
<!-- HuyPQ-end -->
